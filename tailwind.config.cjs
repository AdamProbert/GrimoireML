  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        emberStrong: '0 0 0 1px #FF6F0040, 0 0 14px -2px #FF6F0070, 0 0 30px -6px #FFB30070',
      ...
      backgroundImage: {
        ...
        'ember-radial': 'radial-gradient(circle at 35% 25%,#FF6F0018,#FFB30008 40%,#2C003E00 70%)',
